...
app.end = function(win) {
  ...
  if (win) {
    app.launchScreen(
      app.score.number,
      "Aferinnn!",
      "Güzellll: " + sessionStorage.getItem("results") + ' Bir sonraki seviye daha zor olacak.',
      "Sıradaki seviye"
    );
  } else {
    app.launchScreen(
      0,
      "Üzgünümmm!",
      "Son puanınız: " + sessionStorage.getItem("results") + ' dikkat giderek zorlaşıyor.',
...
app.launchScreen(
  0,
  "Yol bulucu===ÇART APP",
  "En yakın sarı noktayı bulun "+"iyi oyunlar OĞUZHAN ÇART.",
